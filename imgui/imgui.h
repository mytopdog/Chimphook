...
namespace ImGui
{
	...
	IMGUI_API bool          BeginGroupBox(const char* label, const ImVec2& size_arg);
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool ch = false);
	...
	IMGUI_API bool          ColorEdit4(const char* label, Color col, ImGuiColorEditFlags flags = 0);
