...
public:
	...
	int SetRenderTarget(ITexture* pTexture)
	{
		return CallVFunction<int(__thiscall*)(void*, ITexture*)>(this, 6)(this, pTexture);
	}

	void PushRenderTargetAndViewport()
	{
		return CallVFunction<void(__thiscall*)(void*)>(this, 118)(this);
	}

	void PopRenderTargetAndViewport()
	{
		return CallVFunction<void(__thiscall*)(void*)>(this, 119)(this);
	}

	void DrawScreenSpaceRectangle(IMaterial* pMaterial, int destX, int destY, int width, int height, float srcTextureX0, float srcTextureY0, float srcTextureX1, float srcTextureY1,
		int srcTextureWidth, int srcTextureHeight, void* pClientRenderable, int nXDice, int nYDice)
	{
		return CallVFunction<void(__thiscall*)(void*, IMaterial*, int, int, int, int, float, float, float, float, int, int, void*, int, int)>(this, 113)(this,
			pMaterial, destX, destY, width, height, srcTextureX0, srcTextureY0, srcTextureX1, srcTextureY1, srcTextureWidth, srcTextureHeight, pClientRenderable,
			nXDice, nYDice);
	}
